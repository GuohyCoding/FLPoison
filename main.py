...
def omniscient_attack(clients):
    ...
    if is_single_update:
        ...
        omniscient_attackers[0].update = _to_1d_tensor_or_array(malicious_updates)
        for client in omniscient_attackers[1:]:
            client.update = _to_1d_tensor_or_array(client.omniscient(clients))
    else:
        ...
        for client, update in zip(omniscient_attackers, malicious_updates):
            client.update = _to_1d_tensor_or_array(update)
